...
namespace PaberRockKamen
{
    public partial class BotvsBot : Form
    {
        ...
        public BotvsBot()
        {
            ...
            lbl3.Location = new Point(150, 500); //Point(x,y) - местоположение Label
            lbl3.Font = new Font("Oswald", 16, FontStyle.Bold);

            lbl4 = new Label();// создали Label
            lbl4.Text = "0";
            lbl4.Size = new Size(600, 200);//Size(width,height)
            lbl4.Location = new Point(920, 500); //Point(x,y) - местоположение Label
        ...
        private void Btn_Click(object sender, EventArgs e)
        {
            ...
            if (randombot1 == 1)
            {
                ptb.Image = Image.FromFile(@"..\..\image\" + kartinkibot2[0]);
            }
            else if (randombot1 == 2)
            {

                ptb.Image = Image.FromFile(@"..\..\image\" + kartinkibot2[1]);
            }
            else if (randombot1 == 3)
            {

                ptb.Image = Image.FromFile(@"..\..\image\" + kartinkibot2[2]);
            }
